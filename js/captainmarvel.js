fetch("http://superheroapi.com/api/10211817607051908/157",  {method: 'GET'} )
...
fetch("https://content.googleapis.com/youtube/v3/search?maxResults=4&part=snippet&q=captainmarvel&key=AIzaSyA6InuRy7F7wOjeUxDZqrOeDCylBpt-OdY", {method: 'GET'})
.then(response => response.json())
...
fetch("http://www.omdbapi.com/?apikey=7acb37a5&s=captainmarvel", {method: 'GET'})
.then(response => response.json())
